...
const topic = 'ventiladorVelocidadMedia'; // Tópico para enviar la temperatura al ESP32
const message = 'ventiladorMedia'; // Indicador para enviar la lectura de temperatura
